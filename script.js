            ...
            const productsHtml = `
                ...
                <div class="products-grid">
                    ${country.products.map(product => `
                        <div class="product-icon">${product}</div>
                    `).join('')}
                </div>
            `;
